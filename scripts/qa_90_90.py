...
add("44 pré-curso disponível", page.count('href="precurso.html"') >= 1)
...
add("69 abertura por botão", "lesson-toggle" in portal_core)
add("70 uma aula por vez", "closeOtherCourseCards" in portal_core)
...
add("75 logout integrado", "moveLogoutIntoNav" in portal_core and "position:static!important" in portal_css)
...
add("80 pré-curso nos materiais", 'href="precurso.html"' in page and 'id="materialsPanel" hidden' in page)
...
add("85 release r6", 'content="viii-cats-pa-2026-r6"' in page)
add("86 progresso persistente", "cats_pa_progress_v2" in page)
add("87 integração modular atual", "portal-ui-core.js" in portal_js and "presentation-originals.js" in portal_js)
