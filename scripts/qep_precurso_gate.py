...
q(3, 'Qualidade textual', 'catsPersistenceStatus' in pre and 'planilha oficial' in pre.lower(), 'mensagens operacionais e estado de persistência explícitos')
...
q(10, 'Experiência pedagógica', 'Habilidades prévias' in legacy and 'Estado mental prévio' in legacy, 'sequenciamento identificação → experiência → estado mental')
...
q(22, 'Robustez e QA técnico', 'e2e_precurso.py' in workflow and 'Smoke live do verificador' in workflow and 'Smoke + E2E do formulário' in workflow, 'E2E local + smoke live do verificador')
