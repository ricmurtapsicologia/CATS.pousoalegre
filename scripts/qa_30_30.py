...
check("15 Usability", "mobileMenuBtn" in page and "lesson-toggle" in portal_core and "courseInfoToggle" in page)
...
check("25 Decision-readiness", page.count('href="precurso.html"') >= 1 and 'id="materialsPanel" hidden' in page)
check("26 Publication preflight", "embed.tawk.to" not in page and "Tawk.to" not in page)
check("27 Version-drift", 'content="viii-cats-pa-2026-r6"' in page and "cats_pa_progress_v2" in page)
